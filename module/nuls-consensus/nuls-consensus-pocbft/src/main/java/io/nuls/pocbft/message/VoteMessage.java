package io.nuls.pocbft.message;
...
public class VoteMessage extends BaseBusinessMessage {
    ...
    public String getMessageKey(){
        return ConsensusConstant.SEPARATOR + roundIndex + ConsensusConstant.SEPARATOR + packingIndexOfRound + ConsensusConstant.SEPARATOR + voteRound + ConsensusConstant.SEPARATOR + voteStage + ConsensusConstant.SEPARATOR + address;
    }
