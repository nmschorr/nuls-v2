...
import io.nuls.pocbft.model.bo.BlockData;
import io.nuls.pocbft.model.bo.Chain;
import io.nuls.pocbft.model.bo.ChargeResultData;
import io.nuls.pocbft.model.bo.config.ConsensusChainConfig;
import io.nuls.pocbft.model.bo.consensus.AssembleBlockTxResult;
import io.nuls.pocbft.model.bo.round.MeetingMember;
import io.nuls.pocbft.model.bo.round.MeetingRound;
import io.nuls.pocbft.model.po.RandomSeedStatusPo;
import io.nuls.pocbft.rpc.call.CallMethodUtils;
import io.nuls.pocbft.storage.RandomSeedsStorageService;
import io.nuls.pocbft.utils.RandomSeedUtils;
...
public class ConsensusManager {
    ...
    private static void assembleSystemTx(Chain chain, BlockHeader bestBlock, List<Transaction> txList, MeetingMember member, MeetingRound round, long time, boolean settleConsensusAward)throws Exception{
        Transaction coinBaseTransaction = createCoinBaseTx(chain, member, txList, time, settleConsensusAward);
     ...
     * @return Transaction
     */
    public static Transaction createCoinBaseTx(Chain chain, MeetingMember member, List<Transaction> txList, long time, boolean settleConsensusAward)throws Exception{
        ...
        */
        List<CoinTo> rewardList = calcReward(chain, txList, member, settleConsensusAward);
     ...
     * @return List<CoinTo>
     */
    private static List<CoinTo> calcReward(Chain chain, List<Transaction> txList, MeetingMember member, boolean settleConsensusAward) throws  NulsException{
        /*
        资产与共识奖励键值对
        ...
        */
        ...
        if(settleConsensusAward){
            settleConsensusAward(chain, coinToList);
        }
        return coinToList;
    }
     ...
     * */
    private static void settleConsensusAward(Chain chain, List<CoinTo> coinToList){
        //todo
    }
